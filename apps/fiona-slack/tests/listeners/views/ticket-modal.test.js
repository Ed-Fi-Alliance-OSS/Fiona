...
describe('defaultPriorityName', () => {
  it('is Medium when the configured list contains it', () => {
    ...
    process.env.GH_ISSUE_PRIORITY_OPTION_NAMES = 'Low,Medium,High';
    expect(defaultPriorityName()).toBe('Medium');
  });

...
beforeEach(() => {
  ...
  mockPost.mockReset();
  process.env.GH_ISSUE_REPO = 'Ed-Fi-Alliance-OSS/Fiona';
  process.env.GH_ISSUE_TOKEN = 'ghp-secret-token';
  delete process.env.GITHUB_API_URL;
  delete process.env.GH_ISSUE_SLACK_USER_FIELD_NAME;
  delete process.env.GH_ISSUE_PRIORITY_FIELD_NAME;
...
describe('createIssue', () => {
  ...
  it('honors GH_ISSUE_PRIORITY_FIELD_NAME', async () => {
  ...
  it('honors GH_ISSUE_SLACK_USER_FIELD_NAME', async () => {
    process.env.GH_ISSUE_SLACK_USER_FIELD_NAME = 'Jira Key';
  ...
  it('throws github_create_failed naming the field when it is not visible to the token', async () => {
    process.env.GH_ISSUE_SLACK_USER_FIELD_NAME = 'Nonexistent Field';
